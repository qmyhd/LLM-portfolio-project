...
handoffs:
  - label: "🔄 Implement with Portfolio Assistant"
    ...
    prompt: |
      Using the library documentation and best practices I've outlined above, 
      please implement the needed changes in the codebase.
  ...
  - label: "📋 Create Implementation Plan"
    agent: planner
    prompt: |
      Based on the library documentation I've gathered, please create an 
      implementation plan for integrating this library/feature.
    send: false
  - label: "📚 Check Project Docs"
    agent: docs-agent
    prompt: |
      I've found the external library documentation. Now I need to understand 
